...
int component_phone_number(std::string arg, std::string arg1, std::string arg2)
{
	std::string component_number = arg.append(arg1);
	return std::stoi(component_number.append(arg2));
};
